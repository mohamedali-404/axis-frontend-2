...
export default function ProductClient({ initialProduct, relatedProducts = [] }: { initialProduct: any, relatedProducts: any[] }) {
    ...
    return (
        <div className="product-page-container stagger-1">
            ...
            {relatedProducts.length > 0 && (
                <div className="stagger-3" style={{ marginTop: '40px', borderTop: '1px solid var(--border-color)', paddingTop: '24px' }}>
                    ...
                    <div className="product-grid">
                        {relatedProducts.map(rp => (
                            <Link href={`/product/${rp._id}`} key={rp._id} className="product-card" style={{ textDecoration: 'none', color: 'inherit' }}>
