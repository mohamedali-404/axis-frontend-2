...
export default function Footer() {
    ...
    return (
        <footer style={{ backgroundColor: 'var(--accent-color)', color: 'var(--accent-foreground)', padding: '3rem 1.5rem 1.5rem', marginTop: '3rem' }}>
            ...
            <div style={{ maxWidth: 1400, margin: '2rem auto 0', paddingTop: '1.5rem', borderTop: '1px solid rgba(255,255,255,0.1)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', color: 'var(--accent-foreground)' }}>
                <div className="dev-credit-badge" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', gap: '1rem', padding: '16px 24px', backgroundColor: '#0f172a', borderRadius: '16px', border: '1px solid #334155', boxShadow: '0 8px 24px rgba(0,0,0,0.3)', transition: 'transform 0.2s', width: '100%', maxWidth: '600px' }} onMouseOver={e => e.currentTarget.style.transform = 'translateY(-2px)'} onMouseOut={e => e.currentTarget.style.transform = 'translateY(0)'}>
                    <span style={{ fontSize: '1.05rem', fontWeight: 500, letterSpacing: '0.5px', color: '#e2e8f0', textAlign: 'center' }}>
                        Crafted & Developed by <strong style={{ color: '#fff', fontWeight: 900, letterSpacing: '1px', paddingLeft: '4px' }}>Eng. Mohamed Ali</strong>
                    </span>
                    <div style={{ display: 'flex', gap: '12px', alignItems: 'center', justifyContent: 'center' }}>
                        <a href="https://wa.me/201282721189" target="_blank" rel="noopener noreferrer" title="Chat on WhatsApp" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#25D366', backgroundColor: 'rgba(37,211,102,0.1)', padding: '10px', borderRadius: '50%', transition: 'all 0.2s' }} onMouseOver={e => { e.currentTarget.style.backgroundColor = '#25D366'; e.currentTarget.style.color = '#fff' }} onMouseOut={e => { e.currentTarget.style.backgroundColor = 'rgba(37,211,102,0.1)'; e.currentTarget.style.color = '#25D366' }}>
                        ...
                        <a href="https://www.linkedin.com/in/mohamed-ali-00m00" target="_blank" rel="noopener noreferrer" title="Connect on LinkedIn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#0a66c2', backgroundColor: 'rgba(10,102,194,0.1)', padding: '10px', borderRadius: '50%', transition: 'all 0.2s' }} onMouseOver={e => { e.currentTarget.style.backgroundColor = '#0a66c2'; e.currentTarget.style.color = '#fff' }} onMouseOut={e => { e.currentTarget.style.backgroundColor = 'rgba(10,102,194,0.1)'; e.currentTarget.style.color = '#0a66c2' }}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                        </a>
                    </div>
                </div>

                <div style={{ fontSize: '0.9rem', opacity: 0.5, marginTop: '0.5rem', textAlign: 'center' }}>
