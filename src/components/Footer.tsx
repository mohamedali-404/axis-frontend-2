    ...
    return (
        <footer style={{ backgroundColor: 'var(--accent-color)', color: 'var(--accent-foreground)', padding: '6rem 2rem 3rem', marginTop: '6rem' }}>
            ...
            <div style={{ maxWidth: 1400, margin: '5rem auto 0', paddingTop: '2.5rem', borderTop: '1px solid rgba(255,255,255,0.1)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', color: 'var(--accent-foreground)' }}>
                ...
                <div className="dev-credit-badge" style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '12px 24px', backgroundColor: 'rgba(255, 255, 255, 0.03)', borderRadius: '100px', border: '1px solid rgba(255, 255, 255, 0.06)', backdropFilter: 'blur(10px)', transition: 'all 0.3s ease', cursor: 'default' }}>
                    <span style={{ fontSize: '0.85rem', fontWeight: 400, letterSpacing: '0.5px', color: 'rgba(255, 255, 255, 0.7)' }}>
                        Crafted & Developed by <strong style={{ color: '#fff', fontWeight: 700, letterSpacing: '1px' }}>Eng. Mohamed Ali</strong>
                    </span>
                    <div style={{ width: '1px', height: '18px', backgroundColor: 'rgba(255, 255, 255, 0.15)' }}></div>
                    <div style={{ display: 'flex', gap: '10px' }}>
                        <a href="https://wa.me/201282721189" target="_blank" rel="noopener noreferrer" className="dev-social-icon whatsapp-icon" title="Chat on WhatsApp" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(255, 255, 255, 0.7)', padding: '6px', transition: 'all 0.3s ease' }}>
                        ...
                        <a href="https://www.linkedin.com/in/mohamed-ali-00m00?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" className="dev-social-icon linkedin-icon" title="Connect on LinkedIn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(255, 255, 255, 0.7)', padding: '6px', transition: 'all 0.3s ease' }}>
