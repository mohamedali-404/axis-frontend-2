            ...
            <div style={{ maxWidth: 1400, margin: '3rem auto 0', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.1)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', color: 'var(--accent-foreground)' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', padding: '10px 20px', backgroundColor: 'rgba(255, 255, 255, 0.04)', borderRadius: '30px', border: '1px solid rgba(255,255,255,0.08)', backdropFilter: 'blur(10px)', opacity: 0.9 }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                        <a href="https://wa.me/201282721189" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--accent-foreground)', opacity: 0.7, padding: '6px', transition: 'all 0.2s ease', cursor: 'pointer' }} className="hover-opacity" title="Chat on WhatsApp">
                        ...
                        <a href="https://linkedin.com/in/mohamedalielshabrawy" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--accent-foreground)', opacity: 0.7, padding: '6px', transition: 'all 0.2s ease', cursor: 'pointer' }} className="hover-opacity" title="Connect on LinkedIn">
                            <Linkedin size={20} />
                        </a>
                    </div>
                </div>
